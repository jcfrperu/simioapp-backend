...
public class MigracionEXCELCaso02Test extends MigracionTestBase {

    private static Logger log = Logger.getLogger(MigracionEXCELCaso02Test.class.getName());
    ...
    public void migrar01Bienes() throws Exception {
        ...
        InputStream inputStream = new FileInputStream(getFileFromResources("excel/caso02/Inventario2017.xlsm"));

        UsuarioSession usuarioSession = UsuarioSessionImpl.getDefaultTestUser(String.valueOf(ENTIDAD_ID));

        ResultadoMigracionSBNExcelBean result = migracionService.migrarSBNExcelV7(inputStream, usuarioSession, ENTIDAD_ID, false);
    ...
    public static void setLoggerJavaUtilLogging() throws MalformedURLException {
        ...
        log = Logger.getLogger(MigracionEXCELCaso02Test.class.getName());
    }
