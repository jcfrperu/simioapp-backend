...
public class MigracionEXCELCaso03Test extends MigracionTestBase {

    private static Logger log = Logger.getLogger(MigracionEXCELCaso03Test.class.getName());
    ...
    public void migrar01Bienes() throws Exception {
        ...
        InputStream inputStream = new FileInputStream(getFileFromResources("excel/caso03/Inventario2017.xlsm"));
    ...
    public static void setLoggerJavaUtilLogging() throws MalformedURLException {
        ...
        log = Logger.getLogger(MigracionEXCELCaso03Test.class.getName());
    }
