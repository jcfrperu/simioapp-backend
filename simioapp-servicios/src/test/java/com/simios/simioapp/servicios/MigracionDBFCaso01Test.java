...
public class MigracionDBFCaso01Test extends MigracionTestBase {

    private static Logger log = Logger.getLogger(MigracionDBFCaso01Test.class.getName());
    ...
    public void migrar01Locales() throws Exception {
        ...
        InputStream inputStream = new FileInputStream(getFileFromResources("dbfs/caso01/LOCALES.DBF"));
    ...
    public void migrar02Areas() throws Exception {
        ...
        InputStream inputStream = new FileInputStream(getFileFromResources("dbfs/caso01/AREAS.DBF"));
    ...
    public void migrar03Oficinas() throws Exception {
        ...
        InputStream inputStream = new FileInputStream(getFileFromResources("dbfs/caso01/OFICINAS.DBF"));
    ...
    public void migrar04Empleados() throws Exception {
        ...
        InputStream inputStream = new FileInputStream(getFileFromResources("dbfs/caso01/TEMPLEA0.DBF"));
    ...
    public void migrar05Bienes() throws Exception {
        ...
        InputStream inputStream = new FileInputStream(getFileFromResources("dbfs/caso01/MBIENES0.DBF"));
...
//        log = LogManager.getLogger(MigracionDBFCaso01Test.class.getName());
//    }
    ...
    public static void setLoggerJavaUtilLogging() throws MalformedURLException {
        ...
        log = Logger.getLogger(MigracionDBFCaso01Test.class.getName());
    }
