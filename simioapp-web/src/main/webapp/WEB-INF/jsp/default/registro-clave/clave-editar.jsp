...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR CLAVE </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_claveID" type="text" title="ClaveID" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.claveID}">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_claveMetodo" type="text" title="ClaveMetodo" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.claveMetodo}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_claveParams" type="text" title="ClaveParams" maxlength="5000" class="form-control input-sm text-uppercase" value="${registro.claveParams}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_clave" type="text" title="Clave" maxlength="5000" class="form-control input-sm text-uppercase" value="${registro.clave}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="byte_claveBytes" type="text" title="ClaveBytes" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.claveBytes}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_claveBytesLength" type="text" title="ClaveBytesLength" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.claveBytesLength}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-clave.htm?action=guardarEditar',
                    cache: false,
