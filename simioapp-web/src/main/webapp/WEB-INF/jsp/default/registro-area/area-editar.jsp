...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR &Aacute;REA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="int_areaID" type="text" title="C&oacute;digo" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.areaID}">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_abreviaturaArea" type="text" title="Abreviatura" maxlength="15" class="form-control input-sm text-uppercase" value="${registro.abreviaturaArea}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_nombreArea" type="text" title="Nombre" maxlength="150" class="form-control input-sm text-uppercase" value="${registro.nombreArea}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                ...
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <select class="form-control input-sm text-uppercase" title="Local" name="int_localesID">
		                ...
		                <div class="col-md-6">
		                    <div class="form-group">
		                        <label class="control-label">Estado Registro</label>
		                         <select class="form-control input-sm text-uppercase" title="Estado Registro" name="cbo_indDel">
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-area.htm?action=guardarEditar',
                    cache: false,
