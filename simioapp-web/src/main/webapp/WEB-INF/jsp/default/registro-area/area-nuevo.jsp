...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> NUEVA &Aacute;REA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <select class="form-control input-sm text-uppercase" title="Entidad" name="int_entidadID">
    ...
    function eventGuardar() {
        ...
        $('#btn_guardar').on('click', function(e) {
            ...
            showConfirmation('Guardar Registro', '\u00BFSeguro que desea guardar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-area.htm?action=guardarNuevo',
                    cache: false,
