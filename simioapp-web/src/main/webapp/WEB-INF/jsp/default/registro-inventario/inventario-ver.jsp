...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> VER INVENTARIO </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="int_inventarioID" type="text" title="C&oacute;digo" maxlength="10" class="form-control input-sm" value="${registro.inventarioID}">
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="txt_nombre" type="text" title="Nombre" maxlength="100" class="form-control input-sm" value="${registro.nombre}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="fec_fechaApertura" type="text" title="Fecha Apertura" maxlength="10" class="form-control input-sm" value="${registro.fechaApertura}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="fec_fechaCierre" type="text" title="Fecha Cierre" maxlength="10" class="form-control input-sm" value="${registro.fechaCierre}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="txt_estado" type="text" title="Estado" maxlength="1" class="form-control input-sm" value="${registro.estado}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="int_entidadID" type="text" title="Entidad" maxlength="10" class="form-control input-sm" value="${registro.entidadID}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
