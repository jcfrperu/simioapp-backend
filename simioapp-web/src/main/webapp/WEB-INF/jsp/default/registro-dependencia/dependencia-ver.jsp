...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> VER DEPENDENCIA </strong> </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input readonly name="int_dependenciaID" type="text" title="DependenciaID" maxlength="50" class="form-control input-sm" value="${registro.dependenciaID}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">C&oacute;digo Dependencia</label>
                                <input readonly name="txt_codigoDependencia" type="text" title="CodigoDependenc&iacute;a" maxlength="50" class="form-control input-sm" value="${registro.codigoDependencia}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input readonly name="txt_descripcion" type="text" title="Descripci&oacute;n" maxlength="50" class="form-control input-sm" value="${registro.descripcion}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
...
<script>
    ...
    function eventCancelar() {
        ...
        $('#btn_cancelar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-dependencia.htm?action=mostrarBuscar');
        });
    }
