...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> NUEVA DEPENDENCIA </strong> </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_codigoDependencia" type="text" title="C&oactute;digo Dependencia" maxlength="50" class="form-control input-sm text-uppercase">
    ...
    function eventGuardar() {
        ...
        $('#btn_guardar').on('click', function(e) {
            ...
            showConfirmation('Guardar Registro', '\u00BFSeguro que desea guardar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-dependencia.htm?action=guardarNuevo',
                    cache: false,
