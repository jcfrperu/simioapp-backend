...
<table class="table table-striped table-bordered table-hover" id="dependencia-buscar-grilla">

    <thead>
        <tr>
            <th title="Seleccionar Registro">SEL</th>
			<th title="C&oacute;digo de Registro">C&oacute;digo</th>
    ...
    <tbody>
        ...
        <c:forEach items="${lista}" var="item" varStatus="status">
            ...
            <tr class="${claseFila}">
                <td class="text-center"><input type="radio" name="codigo" title="Seleccionar" value="${item.dependenciaID}"></td>
                <td title="Dependencia ID: ${item.dependenciaID}">${item.codigoDependencia}</td>
