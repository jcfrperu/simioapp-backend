...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> EDITAR DEPENDENCIA </strong> </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input readonly name="int_dependenciaID" type="text" title="DependenciaID" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.dependenciaID}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_codigoDependencia" type="text" title="CodigoDependenc&iacute;a" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.codigoDependencia}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>                      
...
<script>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-dependencia.htm?action=guardarEditar',
                    cache: false,
	...
	function initMask() {
        ...
        control = div.find( 'input[name="txt_codigoDependencia"]' );
