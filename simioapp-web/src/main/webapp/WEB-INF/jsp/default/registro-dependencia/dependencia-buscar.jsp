...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> DEPENDENCIAS </strong> </div>
...
<script>
    ...
    function initGrilla() {
        ...
        initDG('#dependencia-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#dependencia-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-dependencia.htm?action=buscarDependencia', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-dependencia.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-dependencia.htm?action=mostrarEditar&dependenciaID=' + selectedID);
        });
    }
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-dependencia.htm?action=eliminarDependencia',
                    cache: false,
                    data: {
                        'dependenciaID': selectedID
                    },
                    async: true,
                    type: 'POST',
                    dataType: 'json',
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-dependencia.htm?action=verDependencia&dependenciaID=' + selectedID);
        });
    }
