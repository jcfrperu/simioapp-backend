...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR CUENTA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="int_cuentaID" type="text" title="C&oacute;digo" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.cuentaID}">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_cuenta" type="text" title="Cuenta" maxlength="11" class="form-control input-sm text-uppercase" value="${registro.cuenta}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <textarea name="txt_denomina" title="Denominaci&oacute;n" maxlength="100" class="form-control input-sm text-uppercase" rows="4"><c:out value='${registro.denomina}' escapeXml='true'></c:out></textarea>
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-cuenta.htm?action=guardarEditar',
                    cache: false,
