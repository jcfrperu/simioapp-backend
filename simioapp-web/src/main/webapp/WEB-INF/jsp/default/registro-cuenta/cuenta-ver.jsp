...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> VER CUENTA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="int_cuentaID" type="text" title="C&oacute;digo" maxlength="10" class="form-control input-sm" value="${registro.cuentaID}">
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="txt_cuenta" type="text" title="Cuenta" maxlength="11" class="form-control input-sm" value="${registro.cuenta}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <textarea readonly name="txt_denomina" title="Denominaci&oacute;n" maxlength="100" class="form-control input-sm text-uppercase" rows="4"><c:out value='${registro.denomina}' escapeXml='true'></c:out></textarea>
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <select disabled class="form-control input-sm text-uppercase" title="Tipo Cuenta" name="txt_tipoCta">
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <select disabled class="form-control input-sm text-uppercase" title="Flag Cuenta" name="txt_flagCta">
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <select disabled class="form-control input-sm text-uppercase" title="Uso Cuenta" name="txt_usoCta">
