...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> NUEVO EMPLEADO </strong> </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_codigo" type="text" title="C&oacute;digo Empleado" maxlength="15" class="form-control input-sm text-uppercase">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_numeroDocIdentPersonal" type="text" title="N&uacute;mero documento" maxlength="15" class="form-control input-sm text-uppercase">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_apellidoMaterno" type="text" title="Apellido Materno" maxlength="50" class="form-control input-sm text-uppercase">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
    ...
    function eventGuardar() {
        ...
        $('#btn_guardar').on('click', function(e) {
            ...
            showConfirmation('Guardar Registro', '\u00BFSeguro que desea guardar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-empleado.htm?action=guardarNuevo',
                    cache: false,
