...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> OPCIONBOTONES </strong> </div>
		            ...
		            <div class="panel-body">
		                <div class="table-responsive" id="div-load-grilla">
		                    <c:import url="/admin.htm">
		                        ...
		                        <c:param name="_page" value="opcionbotones-buscar-grilla" />
		                        <c:param name="_module" value="registro-opcionbotones" />
...
<script>
    ...
    function initGrilla() {
        ...
        initDG('#opcionbotones-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#opcionbotones-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-opcionbotones.htm?action=buscarOpcionBotones', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-opcionbotones.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-opcionbotones.htm?action=mostrarEditar&opcionID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-opcionbotones.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-opcionbotones.htm?action=eliminarOpcionBotones',
                    cache: false,
                    data: {
                        'opcionID': selectedID
                    },
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-opcionbotones.htm?action=verOpcionBotones&opcionID=' + selectedID);
        });
    }
