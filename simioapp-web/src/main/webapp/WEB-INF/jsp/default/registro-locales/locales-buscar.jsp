...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> LOCALES </strong> </div>
            ...
            <div class="col-md-12">
                ...
                <form id="form-buscar" method="POST" role="form">
                    ...
                    <div class="row">
		                ...
		                <input name="txt_codigo" type="text" title="Codigo" maxlength="3" class="form-control input-sm text-uppercase">
                    ...
                    <div class="panel-body">
                        <div id="div-load-grilla">
                            <c:import url="/admin.htm">
                                ...
                                <c:param name="_page" value="locales-buscar-grilla" />
                                <c:param name="_module" value="registro-locales" />
...
<script>
    ...
    function initGrilla() {
        ...
        initDG('#locales-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#locales-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-locales.htm?action=buscarLocales', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-locales.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-locales.htm?action=mostrarEditar&localesID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-locales.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-locales.htm?action=eliminarLocales',
                    cache: false,
                    data: {
                        'localesID': selectedID
                    },
                    async: true,
                    type: 'POST',
                    dataType: 'json',
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-locales.htm?action=verLocales&localesID=' + selectedID);
        });
    }
