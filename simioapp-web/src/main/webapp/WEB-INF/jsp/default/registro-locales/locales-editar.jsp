...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> EDITAR LOCAL </strong> </div>
            ...
            <div class="col-md-12">
                ...
                <form id="form-registro" method="POST" role="form">
                    ...
                    <fieldset>
			            ...
			            <div class="row">
	                        <div class="col-md-4">
	                            <div class="form-group">
	                                ...
	                                <input name="int_localesID" type="text" title="C&oacute;digo" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.localesID}">
                        ...
                        <div class="row">
                        <input name="txt_codigo" type="hidden" value="${registro.codigo}">
							<div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Nombre Local</label>
                                    <input name="txt_nombreLocal" type="text" title="Nombre Local" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.nombreLocal}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                        	<div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="dbl_ctdArea" type="text" title="&Aacute;rea" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.ctdArea}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input name="txt_direccion" type="text" title="Direcci&oacute;n" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.direccion}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
							<div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="txt_numeroMun" type="text" title="N&deg;" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.numeroMun}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="txt_dscMz" type="text" title="Mz" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.dscMz}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="txt_dscLote" type="text" title="Lote" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.dscLote}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="display: none;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="txt_codigoUbigeo" id="txt_codigoUbigeo" type="text" title="Ubigeo" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.codigoUbigeo}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="dbl_ctdValor" type="text" title="Valor Contable" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.ctdValor}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                ...
                <fieldset id="infoRegistral" name="infoRegistral">
                        ...
                        <div class="row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="txt_dscTomo" type="text" title="Tomo" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.dscTomo}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                        	<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="int_dscFojas" type="text" title="Fojas" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.dscFojas}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="txt_dscAsient" type="text" title="Asiento" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.dscAsient}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                        	<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="txt_codigoPredio" type="text" title="C&oacute;digo Predio" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.codigoPredio}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="txt_dscPelect" type="text" title="Partida Electr&oacute;nica" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.dscPelect}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                        	<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="txt_dscAsinab" type="text" title="Registro SINABIP" maxlength="500" class="form-control input-sm text-uppercase" value="${registro.dscAsinab}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="txt_dscPropie" type="text" title="Propiedad Registral" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.dscPropie}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="txt_dscBenefi" type="text" title="Beneficiario" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.dscBenefi}">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-locales.htm?action=guardarEditar',
                    cache: false,
