...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> BOTONESSISTEMA </strong> </div>
		    ...
		    <div class="col-md-12">
		        ...
		        <form id="form-buscar" method="POST" role="form">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        <label class="control-label">BotonID</label>
		                        <input name="int_botonID" type="text" title="BotonID" maxlength="10" class="form-control input-sm text-uppercase">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        <label class="control-label">NombreBot&oacute;n</label>
		                        <input name="txt_nombreBoton" type="text" title="NombreBot&oacute;n" maxlength="50" class="form-control input-sm text-uppercase">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        <label class="control-label">KeyBot&oacute;n</label>
		                        <input name="txt_keyBoton" type="text" title="KeyBot&oacute;n" maxlength="50" class="form-control input-sm text-uppercase">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="panel-body">
		                <div class="table-responsive" id="div-load-grilla">
		                    <c:import url="/admin.htm">
		                        ...
		                        <c:param name="_page" value="botonessistema-buscar-grilla" />
		                        <c:param name="_module" value="registro-botonessistema" />
...
<script>
	...
	function initMask() {
        ...
        control = div.find( 'input[name="int_botonID"]' );
        control.inputmask( "9{0,10}", {placeholder: ''});
        control.prop( 'maxlength', 10 );

        control = div.find( 'input[name="txt_nombreBoton"]' );
        control.inputmask( "[*|| ]{0,50}", {placeholder: ''});
        control.prop( 'maxlength', 50 );

        control = div.find( 'input[name="txt_keyBoton"]' );
        control.inputmask( "[*|| ]{0,50}", {placeholder: ''});
        control.prop( 'maxlength', 50 );
    ...
    function initGrilla() {
        ...
        initDG('#botonessistema-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#botonessistema-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-botonessistema.htm?action=buscarBotonesSistema', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-botonessistema.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-botonessistema.htm?action=mostrarEditar&botonID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-botonessistema.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-botonessistema.htm?action=eliminarBotonesSistema',
                    cache: false,
                    data: {
                        'botonID': selectedID
                    },
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-botonessistema.htm?action=verBotonesSistema&botonID=' + selectedID);
        });
    }
