...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> VER BOTONESSISTEMA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="int_botonID" type="text" title="BotonID" maxlength="10" class="form-control input-sm" value="${registro.botonID}">
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="txt_nombreBoton" type="text" title="NombreBot&oacute;n" maxlength="50" class="form-control input-sm" value="${registro.nombreBoton}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="txt_keyBoton" type="text" title="KeyBot&oacute;n" maxlength="50" class="form-control input-sm" value="${registro.keyBoton}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
