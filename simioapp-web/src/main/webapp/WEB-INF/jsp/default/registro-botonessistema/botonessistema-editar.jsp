...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR BOTONESSISTEMA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_botonID" type="text" title="BotonID" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.botonID}">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_nombreBoton" type="text" title="NombreBot&oacute;n" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.nombreBoton}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_keyBoton" type="text" title="KeyBot&oacute;n" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.keyBoton}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
...
<script>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-botonessistema.htm?action=guardarEditar',
                    cache: false,
    ...
    function eventCancelar() {
        ...
        $('#btn_cancelar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-botonessistema.htm?action=mostrarBuscar');
        });
    }
