...
<table class="table table-striped table-bordered table-hover" id="ubigeo-buscar-grilla">

    <thead>
        <tr>
            <th title="Seleccionar Registro">SEL</th>
            <th>C&oacute;digo Ubigeo</th>
    ...
    <tbody>
        ...
        <c:forEach items="${lista}" var="item" varStatus="status">
            ...
            <tr class="${claseFila}">
                <td class="text-center"><input type="radio" name="codigo" title="Seleccionar" value="${item.ubigeoID}"></td>
                <td>${item.codigoUbigeo}</td>
