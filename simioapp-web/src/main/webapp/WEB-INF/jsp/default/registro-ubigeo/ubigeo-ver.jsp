...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> VER UBIGEO </strong> </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                <label class="control-label">UbigeoID</label>
                                <input readonly name="int_ubigeoID" type="text" title="UbigeoID" maxlength="50" class="form-control input-sm" value="${registro.ubigeoID}">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input readonly name="txt_codigoUbigeo" type="text" title="CodigoUbigeo" maxlength="50" class="form-control input-sm" value="${registro.codigoUbigeo}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
