...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> NUEVA ENTIDAD </strong> </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_codigoEntidad" type="text" title="C&oacute;digo" maxlength="50" class="form-control input-sm text-uppercase">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_rucEntidad" id="txt_rucEntidad" type="text" title="RucEntidad" maxlength="20" class="form-control input-sm text-uppercase">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
    ...
    function eventGuardar() {
        ...
        $('#btn_guardar').on('click', function(e) {
            ...
            showConfirmation('Guardar Registro', '\u00BFSeguro que desea guardar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-entidad.htm?action=guardarNuevo',
                    cache: false,
