...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> VER ENTIDAD </strong> </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input readonly name="int_entidadID" type="text" title="C&oacute;digo" maxlength="50" class="form-control input-sm" value="${registro.entidadID}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input readonly name="txt_codigoEntidad" type="text" title="C&oacute;digo Entidad" maxlength="50" class="form-control input-sm" value="${registro.codigoEntidad}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input readonly name="txt_entidad" type="text" title="Entidad" maxlength="50" class="form-control input-sm" value="${registro.entidad}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input readonly name="txt_rucEntidad" type="text" title="RucEntidad" maxlength="50" class="form-control input-sm" value="${registro.rucEntidad}">
                                <span class="help-block"></span>
                            </div>
                        </div>
