...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> ENTIDADES </strong> </div>
            ...
            <div class="col-md-12">
                ...
                <form id="form-buscar" method="POST" role="form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_codigoEntidad" id="txt_codigoEntidad" type="text" title="C&oacute;digo Entidad" maxlength="50" class="form-control input-sm text-uppercase">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_entidad" type="text" title="Entidad" maxlength="50" class="form-control input-sm text-uppercase">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Ruc de Entidad</label>
                                <input name="txt_rucEntidad" id="txt_rucEntidad" type="text" title="RucEntidad" maxlength="50" class="form-control input-sm text-uppercase">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    ...
                    <div class="panel-body">
                        <div id="div-load-grilla">
                            <c:import url="/admin.htm">
                                ...
                                <c:param name="_page" value="entidad-buscar-grilla" />
                                <c:param name="_module" value="registro-entidad" />
...
<script>
    ...
    function initGrilla() {
        ...
        initDG('#entidad-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#entidad-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-entidad.htm?action=buscarEntidad', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-entidad.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-entidad.htm?action=mostrarEditar&entidadID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-entidad.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-entidad.htm?action=eliminarEntidad',
                    cache: false,
                    data: {
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-entidad.htm?action=verEntidad&entidadID=' + selectedID);
        });
    }
