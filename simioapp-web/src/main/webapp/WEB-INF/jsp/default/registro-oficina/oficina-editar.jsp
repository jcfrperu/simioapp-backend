...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> EDITAR OFICINA </strong> </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Abreviatura Oficina</label>
                                 <input name="int_oficinaID" type="hidden" title="OficinaID" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.oficinaID}">
                                <input name="txt_abreviaturaOficina" type="text" title="Abreviatura Oficina" maxlength="15" class="form-control input-sm text-uppercase" value="${registro.abreviaturaOficina}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_nombreOficina" type="text" title="Nombre Oficina" maxlength="150" class="form-control input-sm text-uppercase" value="${registro.nombreOficina}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="txt_pisoOficina" type="text" title="Piso Oficina" maxlength="15" class="form-control input-sm text-uppercase" value="${registro.pisoOficina}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-oficina.htm?action=guardarEditar',
                    cache: false,
                    data: $('#form-registro').serialize(),
                    async: true,
                    type: 'POST',
