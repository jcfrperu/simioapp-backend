...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR OPCIONSISTEMA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_opcionID" type="text" title="OpcionID" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.opcionID}">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_nombreOpcion" type="text" title="NombreOpci&oacute;n" maxlength="100" class="form-control input-sm text-uppercase" value="${registro.nombreOpcion}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_nivelOpcion" type="text" title="NivelOpci&oacute;n" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.nivelOpcion}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_numeroOrdenOpcion" type="text" title="NumeroOrdenOpci&oacute;n" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.numeroOrdenOpcion}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_urlOpcion" type="text" title="UrlOpci&oacute;n" maxlength="500" class="form-control input-sm text-uppercase" value="${registro.urlOpcion}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_parentOpcion" type="text" title="ParentOpci&oacute;n" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.parentOpcion}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-opcionsistema.htm?action=guardarEditar',
                    cache: false,
