...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> OPCIONSISTEMA </strong> </div>
		            ...
		            <div class="panel-body">
		                <div class="table-responsive" id="div-load-grilla">
		                    <c:import url="/admin.htm">
		                        ...
		                        <c:param name="_page" value="opcionsistema-buscar-grilla" />
		                        <c:param name="_module" value="registro-opcionsistema" />
...
<script>
    ...
    function initGrilla() {
        ...
        initDG('#opcionsistema-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#opcionsistema-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-opcionsistema.htm?action=buscarOpcionSistema', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-opcionsistema.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-opcionsistema.htm?action=mostrarEditar&opcionID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-opcionsistema.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-opcionsistema.htm?action=eliminarOpcionSistema',
                    cache: false,
                    data: {
                        'opcionID': selectedID
                    },
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-opcionsistema.htm?action=verOpcionSistema&opcionID=' + selectedID);
        });
    }
