...
<table class="table table-striped table-bordered table-hover" id="panel-asignacion-grilla">
    ...
    <tbody>
        ...
        <c:forEach items="${lista}" var="item" varStatus="status">
            ...
            <tr class="${claseFila}">
                ...
                <td title="Usuario ID: ${item.inventariadorAnterior}">${item.inventariadorAnteriorDescrip}</td>
