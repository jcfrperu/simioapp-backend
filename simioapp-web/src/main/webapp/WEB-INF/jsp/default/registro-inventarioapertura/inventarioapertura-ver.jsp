...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> VER INVENTARIOAPERTURA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="int_inventarioAperturaID" type="text" title="InventarioAperturaID" maxlength="10" class="form-control input-sm" value="${registro.inventarioAperturaID}">
