...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR INVENTARIOAPERTURA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_inventarioAperturaID" type="text" title="InventarioAperturaID" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.inventarioAperturaID}">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_inventarioID" type="text" title="InventarioID" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.inventarioID}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_estadoSubida" type="text" title="EstadoSubida" maxlength="1" class="form-control input-sm text-uppercase" value="${registro.estadoSubida}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_sobranteFaltante" type="text" title="SobranteFaltante" maxlength="1" class="form-control input-sm text-uppercase" value="${registro.sobranteFaltante}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_inventariador" type="text" title="Inventariador" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.inventariador}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_tipo" type="text" title="Tipo" maxlength="100" class="form-control input-sm text-uppercase" value="${registro.tipo}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_numeroResolucionDisp" type="text" title="NumeroResolucionDisp" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.numeroResolucionDisp}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_codigoBarras" type="text" title="CodigoBarras" maxlength="200" class="form-control input-sm text-uppercase" value="${registro.codigoBarras}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_inventariadoPor" type="text" title="InventariadoPor" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.inventariadoPor}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_revisadoToma" type="text" title="RevisadoToma" maxlength="1" class="form-control input-sm text-uppercase" value="${registro.revisadoToma}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_inventariadorAnterior" type="text" title="InventariadorAnterior" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.inventariadorAnterior}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
...
<script>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-inventarioapertura.htm?action=guardarEditar',
                    cache: false,
    ...
    function eventCancelar() {
        ...
        $('#btn_cancelar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-inventarioapertura.htm?action=mostrarBuscar');
        });
    }
