...
<table class="table table-striped table-bordered table-hover" id="inventarioapertura-buscar-grilla">

    <thead>
        <tr>
            <th title="Seleccionar Registro">SEL</th>
                        <th>InventarioAperturaID</th>
            <th>BienID</th>
            <th>InventarioID</th>
            <th>EstadoSubida</th>
    ...
    <tbody>
        ...
        <c:forEach items="${lista}" var="item" varStatus="status">
            ...
            <tr class="${claseFila}">
                <td class="text-center"><input type="radio" name="codigo" title="Seleccionar" value="${item.inventarioAperturaID}"></td>
                                <td>${item.inventarioAperturaID}</td>
                <td>${item.bienID}</td>
