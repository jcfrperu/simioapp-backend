...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> VER GRUPO </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="int_grupoID" type="text" title="C&oacute;digo" maxlength="10" class="form-control input-sm" value="${registro.grupoID}">
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="txt_grupo" type="text" title="Grupo" maxlength="2" class="form-control input-sm" value="${registro.grupo}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="txt_descripcion" type="text" title="Descripci&oacute;n" maxlength="40" class="form-control input-sm" value="${registro.descripcion}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
