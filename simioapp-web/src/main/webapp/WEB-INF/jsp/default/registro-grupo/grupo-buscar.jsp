...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> GRUPOS </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_grupo" type="text" title="Grupo" maxlength="2" class="form-control input-sm text-uppercase">
		                ...
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_descripcion" type="text" title="Descripci&oacute;n" maxlength="40" class="form-control input-sm text-uppercase">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="panel-body">
		                <div id="div-load-grilla">
		                    <c:import url="/admin.htm">
		                        ...
		                        <c:param name="_page" value="grupo-buscar-grilla" />
		                        <c:param name="_module" value="registro-grupo" />
...
<script>
    ...
    function initGrilla() {
        ...
        initDG('#grupo-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#grupo-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-grupo.htm?action=buscarGrupo', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-grupo.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-grupo.htm?action=mostrarEditar&grupoID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-grupo.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-grupo.htm?action=eliminarGrupo',
                    cache: false,
                    data: {
                        'grupoID': selectedID
                    },
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-grupo.htm?action=verGrupo&grupoID=' + selectedID);
        });
    }
