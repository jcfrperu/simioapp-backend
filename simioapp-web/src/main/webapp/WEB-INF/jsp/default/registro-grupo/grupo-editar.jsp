...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR GRUPO </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input readonly name="int_grupoID" type="text" title="C&oacute;digo" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.grupoID}">
		            ...
		            <div class="row">
		            	<div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_grupo" type="text" title="Grupo" maxlength="2" class="form-control input-sm text-uppercase" value="${registro.grupo}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_descripcion" type="text" title="Descripci&oacute;n" maxlength="40" class="form-control input-sm text-uppercase" value="${registro.descripcion}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
...
<script>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-grupo.htm?action=guardarEditar',
                    cache: false,
    ...
    function eventCancelar() {
        ...
        $('#btn_cancelar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-grupo.htm?action=mostrarBuscar');
        });
    }
