...
<table class="table table-striped table-bordered table-hover" id="grupo-buscar-grilla">
    ...
    <tbody>
        ...
        <c:forEach items="${lista}" var="item" varStatus="status">
            ...
            <tr class="${claseFila}">
                <td class="text-center"><input type="radio" name="codigo" title="Seleccionar" value="${item.grupoID}"></td>
                <td>${item.grupo}</td>
