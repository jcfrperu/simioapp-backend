            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="txt_apellidoPaterno" type="text" title="ApellidoPaterno" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.apellidoPaterno}">
                        <span class="help-block"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="txt_apellidoMaterno" type="text" title="ApellidoMaterno" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.apellidoMaterno}">
                        <span class="help-block"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="txt_clave" type="text" title="Clave" maxlength="250" class="form-control input-sm text-uppercase" value="${registro.clave}">
                        <span class="help-block"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="txt_usuariocol" type="text" title="Usuariocol" maxlength="45" class="form-control input-sm text-uppercase" value="${registro.usuariocol}">
                        <span class="help-block"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="byte_claveAes" type="text" title="ClaveAes" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.claveAes}">
                        <span class="help-block"></span>
                    </div>
                </div>
            </div>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-usuario.htm?action=guardarEditar',
                    cache: false,
