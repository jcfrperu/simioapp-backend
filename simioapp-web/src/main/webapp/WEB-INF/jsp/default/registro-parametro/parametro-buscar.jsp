...
<div class="panel panel-info">
	<div class="panel-heading"> <strong> PAR&Aacute;METROS </strong> </div>
                    ...
                    <div class="panel-body">
                        <div id="div-load-grilla">
                            <c:import url="/admin.htm">
                                ...
                                <c:param name="_page" value="parametro-buscar-grilla" />
                                <c:param name="_module" value="registro-parametro" />
...
<script>
	...
	function initMask() {
        ...
        var control = div.find( 'input[name="txt_nombre"]' );
    ...
    function initGrilla() {
        ...
        initDG('#parametro-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#parametro-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-parametro.htm?action=buscarParametro', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-parametro.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-parametro.htm?action=mostrarEditar&parametroID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-parametro.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-parametro.htm?action=eliminarParametro',
                    cache: false,
                    data: {
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-parametro.htm?action=verParametro&parametroID=' + selectedID);
        });
    }
