...
<div class="panel panel-info">
    ...
    <div class="panel-heading"> <strong> IMPORTAR DATA: EXCEL SBN </strong> </div>
    <div class="panel-body">
		...
		<div class="row" id="div-panel-registro">
		    <div class="col-md-12">
		        ...
		        <form id="form-registro" action="importacion-excel.htm?action=importarArchivoEXCEL" method="post" enctype="multipart/form-data" role="form">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        <label class="control-label">Archivo EXCEL SBN</label>
		                        <input id="file_archivo_excel" name="file_archivo_excel" type="file" > <br />
		                        <span class="help-block"></span>
		                    </div>
		                </div>
						<div class="col-md-6">
							<div class="form-group">
                                ...
                                <select class="form-control input-sm" title="Ignora la entidad del Excel SBN, y usa entidad del usuario en sesi&oacute;n (${entidad_id})" name="cboForzarUsoEntidadSession">
