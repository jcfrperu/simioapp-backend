...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR PERMISOSSISTEMA </strong> </div>
...
<script>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-permisossistema.htm?action=guardarEditar',
                    cache: false,
    ...
    function eventCancelar() {
        ...
        $('#btn_cancelar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-permisossistema.htm?action=mostrarBuscar');
        });
    }
