...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> PERMISOSSISTEMA </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_opcionID" type="text" title="OpcionID" maxlength="10" class="form-control input-sm text-uppercase">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="panel-body">
		                <div class="table-responsive" id="div-load-grilla">
		                    <c:import url="/admin.htm">
		                        ...
		                        <c:param name="_page" value="permisossistema-buscar-grilla" />
		                        <c:param name="_module" value="registro-permisossistema" />
...
<script>
    ...
    function initGrilla() {
        ...
        initDG('#permisossistema-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#permisossistema-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-permisossistema.htm?action=buscarPermisosSistema', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-permisossistema.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-permisossistema.htm?action=mostrarEditar&usuarioID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-permisossistema.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-permisossistema.htm?action=eliminarPermisosSistema',
                    cache: false,
                    data: {
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-permisossistema.htm?action=verPermisosSistema&usuarioID=' + selectedID);
        });
    }
