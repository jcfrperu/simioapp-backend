...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR USUARIOSESSION </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_usuarioID" type="text" title="UsuarioID" maxlength="50" class="form-control input-sm text-uppercase" value="${registro.usuarioID}">
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="fec_ultimoLogin" type="text" title="UltimoLogin" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.ultimoLogin}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="fec_ultimoCierre" type="text" title="UltimoCierre" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.ultimoCierre}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="fec_ultimaAccion" type="text" title="UltimaAcci&oacute;n" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.ultimaAccion}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_minutosValidez" type="text" title="MinutosValidez" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.minutosValidez}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_estado" type="text" title="Estado" maxlength="3" class="form-control input-sm text-uppercase" value="${registro.estado}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_indPoliticaInactividad" type="text" title="IndPoliticaInactividad" maxlength="1" class="form-control input-sm text-uppercase" value="${registro.indPoliticaInactividad}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_datosIpLogin" type="text" title="DatosIpLogin" maxlength="100" class="form-control input-sm text-uppercase" value="${registro.datosIpLogin}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_datosIpAccion" type="text" title="DatosIpAcci&oacute;n" maxlength="100" class="form-control input-sm text-uppercase" value="${registro.datosIpAccion}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_indPoliticaIntentos" type="text" title="IndPoliticaIntentos" maxlength="1" class="form-control input-sm text-uppercase" value="${registro.indPoliticaIntentos}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_numeroIntentos" type="text" title="NumeroIntentos" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.numeroIntentos}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_nombresUsuario" type="text" title="NombresUsuario" maxlength="100" class="form-control input-sm text-uppercase" value="${registro.nombresUsuario}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_apellidosUsuario" type="text" title="ApellidosUsuario" maxlength="100" class="form-control input-sm text-uppercase" value="${registro.apellidosUsuario}">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-usuariosession.htm?action=guardarEditar',
                    cache: false,
