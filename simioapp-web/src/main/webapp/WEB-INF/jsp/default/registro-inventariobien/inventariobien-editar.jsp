...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> EDITAR INVENTARIOBIEN </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_inventarioBienID" type="text" title="InventarioBienID" maxlength="10" class="form-control input-sm text-uppercase" value="${registro.inventarioBienID}">
    ...
    function eventGuardar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            showConfirmation('Editar Registro', '\u00BFSeguro que desea editar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-inventariobien.htm?action=guardarEditar',
                    cache: false,
