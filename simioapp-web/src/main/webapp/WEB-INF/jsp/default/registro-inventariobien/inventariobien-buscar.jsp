...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> INVENTARIOBIEN </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="int_inventarioBienID" type="text" title="InventarioBienID" maxlength="10" class="form-control input-sm text-uppercase">
		            ...
		            <div class="panel-body">
		                <div class="table-responsive" id="div-load-grilla">
		                    <c:import url="/admin.htm">
		                        ...
		                        <c:param name="_page" value="inventariobien-buscar-grilla" />
		                        <c:param name="_module" value="registro-inventariobien" />
...
<script>
	...
	function initMask() {
        ...
        control = div.find( 'input[name="int_inventarioBienID"]' );
    ...
    function initGrilla() {
        ...
        initDG('#inventariobien-buscar-grilla', true, true, null);

        eventSelectOnTR('#inventariobien-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-inventariobien.htm?action=buscarInventarioBien', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-inventariobien.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-inventariobien.htm?action=mostrarEditar&inventarioBienID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-inventariobien.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-inventariobien.htm?action=eliminarInventarioBien',
                    cache: false,
                    data: {
                        'inventarioBienID': selectedID
                    },
                    async: true,
                    type: 'POST',
                    dataType: 'json',
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-inventariobien.htm?action=verInventarioBien&inventarioBienID=' + selectedID);
        });
    }
