...
<div class="panel panel-info">
    <div class="panel-heading"> <strong> CLASES </strong> </div>
		            ...
		            <div class="row">
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_clase" type="text" title="Clase" maxlength="2" class="form-control input-sm text-uppercase">
		                ...
		                <div class="col-md-6">
		                    <div class="form-group">
		                        ...
		                        <input name="txt_descripcion" type="text" title="Descripci&oacute;n" maxlength="30" class="form-control input-sm text-uppercase">
		                        <span class="help-block"></span>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="panel-body">
		                <div id="div-load-grilla">
		                    <c:import url="/admin.htm">
		                        ...
		                        <c:param name="_page" value="clase-buscar-grilla" />
		                        <c:param name="_module" value="registro-clase" />
...
<script>
    ...
    function initGrilla() {
        ...
        initDG('#clase-buscar-grilla', true, true, true, null, null);

        eventSelectOnTR('#clase-buscar-grilla');
    }
    ...
    function cargarGrilla() {
        ...
        $('#div-load-grilla').load('registro-clase.htm?action=buscarClase', paramsBuscar, function(response, status, xhr) {
    ...
    function eventNuevo() {
        ...
        $('#btn_nuevo').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-clase.htm?action=mostrarNuevo');
        });
    }
    ...
    function eventEditar() {
        ...
        $('#btn_editar').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-clase.htm?action=mostrarEditar&claseID=' + selectedID);
        });
    }
    ...
    function eventBuscar() {
        ...
        $('#btn_buscar').on('click', function(e) {
            ...
            $.ajax({
                url: 'registro-clase.htm?action=validarBuscar',
                cache: false,
    ...
    function eventEliminar() {
        ...
        $('#btn_eliminar').on('click', function(e) {
            ...
            showConfirmation('Eliminar registro', '\u00BFSeguro que desea eliminar el registro?', function() {
                ...
                $.ajax({
                    url: 'registro-clase.htm?action=eliminarClase',
                    cache: false,
                    data: {
                        'claseID': selectedID
                    },
    ...
    function eventVer() {
        ...
        $('#btn_ver').on('click', function(e) {
            ...
            $(location).prop('href', 'registro-clase.htm?action=verClase&claseID=' + selectedID);
        });
    }
