...
public class SobranteFaltanteController extends BaseController {

    private static final Logger log = Logger.getLogger(SobranteFaltanteController.class.getName());

    private static final String plantilla = "default";
    private static final String modulo = "panel-sobrante-faltante";
    ...
    public ModelAndView mostrarPanelSobranteFaltante(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            setVistaTemplate(model, "panel-sobrante-faltante", modulo, plantilla);
    ...
    public ModelAndView guardar(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            String sobranteFaltante = JS.toBlank(request.getParameter("sobranteFaltante"));
            ...
            inventarioBienService.guardarSobranteFaltante(ids, SETEAR_NULL_ID.equals(sobranteFaltante) ? null : sobranteFaltante);
